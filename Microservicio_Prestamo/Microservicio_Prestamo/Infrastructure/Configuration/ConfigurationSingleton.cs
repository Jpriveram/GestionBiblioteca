...
public class ConfigurationSingleton
{
    ...
    private string _connectionString = "Server=localhost;Database=prestamosbd;User Id=root;Password=root;";
    ...
    public static void Initialize(IConfiguration configuration)
    {
        _instancia._connectionString = configuration.GetConnectionString("DefaultConnection")
            ?? "Server=localhost;Database=prestamosbd;User Id=root;Password=root;";
    }
