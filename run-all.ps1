...
Start-Process powershell -ArgumentList '-NoExit','-Command','Write-Host Prestamo:5081 -ForegroundColor Red; dotnet run --no-build' -WorkingDirectory "$repoRoot\Microservicio_Prestamo\Microservicio_Prestamo"
